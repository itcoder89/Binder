package com.brosis.doubledate.Firebase_Notification;
...
public class Notification_Receive extends FirebaseMessagingService {
    ...
    private class sendNotification extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            ...
            if(NewTabHome.newTabHome!=null){
              ...
              View layout = NewTabHome.newTabHome.getLayoutInflater().inflate(R.layout.item_layout_custom_notification,null);
              ...
              snackbar = Snackbar.make(NewTabHome.newTabHome.findViewById(R.id.container), "", Snackbar.LENGTH_LONG);
               ...
               handler.postDelayed(runnable, 2750);
                ...
                layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        snackbar.dismiss();
                        snackbar.getView().setVisibility(View.INVISIBLE);
                        chatFragment(NewTabHome.user_id,senderid,title,false);
    ...
    public void chatFragment(String senderid,String receiverid,String name,boolean is_match_exits){
        ...
        FragmentTransaction transaction = NewTabHome.newTabHome.getSupportFragmentManager().beginTransaction();
        ...
        Intent intent=new Intent(Notification_Receive.this, Chat_Activity.class);
