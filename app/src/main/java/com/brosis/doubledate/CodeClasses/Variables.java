...
public class Variables {
    ...
    public static String domain="http://doubledate.brosisbiz.com/android/API/index.php?p=";
    public static String image_base_url="http://doubledate.brosisbiz.com/android/API/";
