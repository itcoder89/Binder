package com.brosis.doubledate.Main_Menu;
...
import com.brosis.doubledate.Main_Menu.RelateToFragment_OnBack.OnBackPressListener;
...
public class MainMenuFragment extends RootFragment implements View.OnClickListener {
    ...
    private void setupTabIcons() {
        ...
        if(NewTabHome.action_type.equals("message")){
            pager.setCurrentItem(3);
            chatFragment();
        }

        else if(NewTabHome.action_type.equals("match")){
            pager.setCurrentItem(3);
        }
    ...
    public void chatFragment(){
        ...
        args.putString("Sender_Id",NewTabHome.user_id);
        args.putString("Receiver_Id",NewTabHome.receiverid);
        args.putString("name",NewTabHome.title);
        args.putString("picture",NewTabHome.Receiver_pic);
