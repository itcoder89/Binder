package com.brosis.doubledate.Boost;
...
public class Boost_F extends RootFragment implements View.OnClickListener {
    ...
    public boolean Check_IS_Boost_On(){
        ...
        long requesttime= Long.parseLong(NewTabHome.sharedPreferences.getString(Variables.Boost_On_Time,"0"));
        ...
        ApiRequest.Call_Api(context, Variables.boostProfile, parameters, new Callback() {
            ...
            public void Responce(String resp) {
                ...
                try {
                    ...
                    NewTabHome.sharedPreferences.edit().putString(Variables.Boost_On_Time,""+min).commit();
