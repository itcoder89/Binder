package com.brosis.doubledate.InAppSubscription;
...
public class InApp_Subscription_A extends AppCompatActivity implements BillingProcessor.IBillingHandler,View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        context=InApp_Subscription_A.this;
        ...
        sub_layout1= findViewById(R.id.sub_layout1);
        sub_layout2= findViewById(R.id.sub_layout2);
        sub_layout3= findViewById(R.id.sub_layout3);
    ...
    public void onProductPurchased(@NonNull String productId, @Nullable TransactionDetails details) {
        ...
        NewTabHome.purduct_purchase=true;
    ...
    public void Puchase_item() {
        boolean isAvailable = BillingProcessor.isIabServiceAvailable(InApp_Subscription_A.this);
        if(isAvailable) {

            if(subscription_position==1){
                bp.subscribe(InApp_Subscription_A.this, Variables.product_ID);
            }else if(subscription_position==2){
                bp.subscribe(InApp_Subscription_A.this, Variables.product_ID2);
            }
            else if(subscription_position==3){
                bp.subscribe(InApp_Subscription_A.this, Variables.product_ID3);
            }
    ...
    public void Set_Slider(){
        ...
        try {
            mPager.setAdapter(new SlidingImageAdapter(InApp_Subscription_A.this,ImagesArray));
        }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.Goback:
                InApp_Subscription_A.this.onBackPressed();
                break;
