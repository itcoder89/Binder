package com.brosis.doubledate.Inbox;
...
import com.brosis.doubledate.Chat.Chat_Activity;
import com.brosis.doubledate.CodeClasses.AdapterClickListener;
import com.brosis.doubledate.CodeClasses.ApiRequest;
import com.brosis.doubledate.CodeClasses.Callback;
import com.brosis.doubledate.CodeClasses.Fragment_Callback;
import com.brosis.doubledate.CodeClasses.Functions;
import com.brosis.doubledate.CodeClasses.Variables;
import com.brosis.doubledate.Firebase_Notification.Notification_Receive;
...
public class Inbox_F extends RootFragment implements  View.OnClickListener {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        inbox_adapter=new Inbox_Adapter(context, inbox_arraylist, new AdapterClickListener() {
            ...
            public void onItemClick(int pos, Object object, View view) {
                ...
                if(check_ReadStoragepermission())
                    chatFragment(NewTabHome.user_id,item.getId(),item.getName(),item.getPicture(),false);
        ...
        matches_adapter=new Matches_Adapter(context, matchs_users_list, new AdapterClickListener() {
            @Override
            public void onItemClick(int pos, Object object, View view) {
                LocalStorage.setIsFragmentOpen(getActivity(),"true");
                Match_Get_Set item=(Match_Get_Set)object;
                if(check_ReadStoragepermission())
                    chatFragment(NewTabHome.user_id,item.getU_id(),item.getUsername(),item.getPicture(),true);
    ...
    public void onStart() {
        ...
        inbox_query=root_ref.child("Inbox").child(NewTabHome.user_id).orderByChild("date");
    ...
    public void chatFragment(String senderid,String receiverid,String name,String picture,boolean is_match_exits){
        ...
        intent.putExtra("is_match_exits",is_match_exits);
